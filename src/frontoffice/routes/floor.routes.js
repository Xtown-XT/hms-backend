...
// Admin-only routes
router.get("/floors", verifyToken, authorizeRole(["admin"]), FloorController.getAllFloors);
...
router.delete("/floor/:id", verifyToken, authorizeRole(["admin"]), FloorController.deleteFloor);
