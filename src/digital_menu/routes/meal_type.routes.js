...
router.post('/createmealtype', verifyToken, authorizeRole(['admin']), MealTypeController.createMealType);
...
router.put('/updatemealtype/:id', verifyToken, authorizeRole(['admin']), MealTypeController.updateMealType);
router.delete('/deletemealtype/:id', verifyToken, authorizeRole(['admin']), MealTypeController.deleteMealType);
